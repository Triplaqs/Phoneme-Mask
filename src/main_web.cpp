...
#include <GLES3/gl3.h>
//OpenGL et rendering
//#include <glad/glad.h> //pas nécessaire en Web
...
//création objet Shader
    ...
    fitScale = (maxRange > 0.0f) ? (2.0f / maxRange) : 1.0f; // mappe la plus grande étendue sur [-1,1]
...
/*
emcc src/main_web.cpp src/animation.cpp src/vertex.cpp Imgui/imgui.cpp Imgui/imgui_draw.cpp Imgui/imgui_tables.cpp Imgui/imgui_widgets.cpp Imgui/imgui_impl_glfw.cpp ./Imgui/imgui_impl_opengl3.cpp -o web/index.html -s USE_GLFW=3 -s USE_WEBGL2=1 -s WASM=1 -std=c++17
